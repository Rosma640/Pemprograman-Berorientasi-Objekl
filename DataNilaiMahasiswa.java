...
class Exam {
    ...
    public Mahasiswa[] sortStudents(Mahasiswa[] students) {
        for (int i = 0; i < students.length; i++) {
            ...
            while(position >= 1 && students[position - 1].getGrade().charAt(0) > temp.getGrade().charAt(0)){
    ...
    public void getSummaryOfStudents() {
        ...
        Mahasiswa[][] categorizedStudentsByGrade = this.categorizeStudentsByGrade(arrayOfStudents);
    ...
    public void getExamResult() {
        for (Mahasiswa student: this.students) {
            ...
            System.out.println("=================================");
            if (student.getGrade().equals("A") || student.getGrade().equals("B") || student.getGrade().equals("C")) {
        ...
        System.out.println("Jumlah Mahasiswa yang lulus : " + this.passedStudents.size() + " yaitu " + this.mapStudents(this.passedStudents));
        System.out.println("Jumlah Mahasiswa yang tidak lulus  : "  + this.failedStudents.size() + " yaitu " + this.mapStudents(this.failedStudents));
